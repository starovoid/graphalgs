...
mod tests {
    ...
    #[test]
    fn test_prim() {
        assert_eq!(prim(&graph1(), |edge| *edge.weight()), vec![(4, 0), (1, 4), (3, 1), (2, 3)]);
        assert_eq!(prim(&graph2(), |edge| *edge.weight()), vec![(1, 0), (2, 1), (4, 3), (5, 4), (6, 5)]);
        assert_eq!(prim(&graph1(), |edge| - *edge.weight()), vec![(1, 0), (2, 1), (4, 0), (3, 4)]);
        assert_eq!(prim(&graph2(), |edge| - *edge.weight()), vec![(2, 0), (1, 2), (4, 3), (6, 4), (5, 4)]);
    }     
}
